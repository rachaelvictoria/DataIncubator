...
##Background
The "Let Everyone Dream" campaign, recently announced at the White House Science Fair, is a 90 million (USD) multi-sector initiative to expand STEM opportunities; with a special focus on underrepresented student demographics. This initiative includes(ref 1):
...
The push for STEM opportunities is not limited to  increasing the number of underrepresented students who choose a STEM career path. Intel recently announced a $300 million initiative (ref 2) to have full representation of women and minorities in the technology workforce by 2020. This funding will be used to:
...
![Demographics of 12th Graders in Top 10 Schools Counties](./University County Demographics - 12th gradersA.png) 
###Discussion and Possible Further Work
These intial exploratory plots show large disparities between the demographics of the top then STEM degree granting universities and the population of 12th graders living in the same county. If the University of Florida's STEM Undergraduate demographics matched that of their surrounding county roughly 40% of the STEM student body would be be African American. The data sets plotted do not consider gender but this paramter is avaialble in the raw data collected. Looking at demographic breakdowns by major, rather than aggregated STEM fields, over all universities and including a breakdown by gender could offer high level insight into the STEM focus many of the newly announced STEM initiatives could explore. 


ref 1: https://www.whitehouse.gov/the-press-office/2015/03/23/fact-sheet-president-obama-announces-over-240-million-new-stem-commitmen  
ref 2: http://fortune.com/2015/01/12/intel-diversity/
