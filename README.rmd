...
These intial exploratory plots show large disparities between the demographics of the top then STEM degree granting universities and the population of 12th graders living in the same county. If the University of Florida's STEM Undergraduate demographics matched that of their surrounding county roughly 40% of the STEM student body would be be African American. This data set plotted does not consider gender but this paramter is avaialble in the raw data collected. Looking at demographic breakdowns by major, rather than aggregated STEM fields, over all universities and including a breakdown by gender could offer high level insight into the STEM focus many of the new STEM initiatives could explore. 
